...
import { cartItems, deleteItemFromCartAsync, fetchItemsByUserIdAsync, updateCartAsync } from '../features/cart/cartSlice';
...
export default function CheckOutCart({handleOrder,setTotalAmount,setTotalItems}) {
